...
val md_theme_light_secondary = Color(0xFF34A853)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFF90F0A3)
val md_theme_light_onSecondaryContainer = Color(0xFF00210A)

val md_theme_light_tertiary = Color(0xFFF9AB00)
...
val md_theme_dark_secondary = Color(0xFF74D489)
val md_theme_dark_onSecondary = Color(0xFF003916)
val md_theme_dark_secondaryContainer = Color(0xFF005323)
val md_theme_dark_onSecondaryContainer = Color(0xFF90F0A3)
...
// Custom colors that might still be useful
val ColorGoogleRed = Color(0xFFEA4335)
val ColorGoogleYellow = Color(0xFFFBBC05)
val ColorGoogleGreen = Color(0xFF34A853)
